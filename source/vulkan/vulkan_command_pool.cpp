...
vk::command_pool::command_pool(vk::device& t_device, uint32_t t_queue_family_index, VkCommandPoolCreateFlags t_flags) : i_device_object{t_device} {
	
	VkCommandPoolCreateInfo command_pool_info = {};
	command_pool_info.sType = VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO;
	command_pool_info.pNext = nullptr;
	command_pool_info.flags = t_flags;
